                ...
                <div className="col-md-6 col-lg-3">
                    <div className="card bg-light">
                        ...
                        <Image src="https://randomuser.me/api/portraits/men/11.jpg" className="rounded-circle " alt="" height="128" width="128" />
                            ...
                            <a href="#"><i className="be bi-facebook text-dark mx-1"></i></a>
                            <a href="#"><i className="be bi-linkedin text-dark mx-1"></i></a>
                            <a href="#"><i className="be bi-instagram text-dark mx-1"></i></a>
                        </div>
                    </div>
                </div>
                <div className="col-md-6 col-lg-3">
